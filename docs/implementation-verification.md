...
[画面デザイン改善](design/2026-09-23-visual-refresh.md)を反映して全検証を再実行した。単体112件、E2E42件、型検査69ファイル、通常ビルド、生成リンク163件が成功。トップ・商品詳細のレスポンシブ表示、寸法フィルタの開閉とURL復元、不正値の案内を追加検証した。商品データと計算式は変更していない。
